            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>DAILY FORECAST LIST <?php
		...
		<?php echo anchor(site_url('index.php/daily_forecast/pdf_latest'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-primary btn-sm"'); ?>
      ...
      <ol class="breadcrumb">
	    ...
	    <tbody>
            <?php
            $start = 0;
            foreach ($this->Daily_forecast_model->get_all_last_10days() as $daily_forecast)
            {
       ...
       <?php
       echo anchor('index.php/daily_forecast/create2_1/','Archive',array('class'=>'btn btn-danger btn-sm'));
