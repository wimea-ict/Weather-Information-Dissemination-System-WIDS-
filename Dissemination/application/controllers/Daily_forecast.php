...
public function create()
    {
	    ...
	    // 'max_temp' => set_value('max_temp'),
	    // 'min_temp' => set_value('min_temp'),
	    // 'sunrise' => set_value('sunrise'),
	    // 'sunset' => set_value('sunset'),
        // 'wind' => set_value('wind'),
    ...
    private function do_upload(){
        if (is_uploaded_file($_FILES["pic"]["tmp_name"]))
            move_uploaded_file($_FILES["pic"]["tmp_name"], "./assets/frameworks/adminlte/img".$_FILES["pic"]["name"]);
