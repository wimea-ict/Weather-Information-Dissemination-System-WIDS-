		...
		<?php echo anchor(site_url('index.php/daily_forecast/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-primary btn-sm"'); ?></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
	    ...
	    <tbody>
            <?php
            $start = 0;
            foreach ($this->Daily_forecast_model->get_all() as $daily_forecast)
            {
