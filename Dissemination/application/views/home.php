...
<!-- seeting the time interval of the animation on the homepage -->
<script>
$('.carousel').carousel({
  interval: 1000 * 10
});
           ...
           $LE_Kwidget = $LE_values['widget'];
             ...
             ?>
                     ...
                     <div id="text-carousel" class="carousel slide" data-ride="carousel" data-pause="false" data-interval=10000>
                           ...
                           <!-- early morning weather forecast -->
                               <div class="item active animated fadeInUp"> 
                                  ...
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $EM_Ktime_duration ?></p>
                      ...
                      <!-- second item -->
                          ...
                          <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LM_Ktime_duration ?></p>
                        ...
                        <!-- third item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $A_Ktime_duration ?></p>
                        ...
                        <!-- fourth item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LE_Ktime_duration ?></p>
                   ...
                   <div class="full-center">
                    ...
                    $LE_jinja  = "SELECT daily_forecast.max_temp, daily_forecast.wind, daily_forecast.mean_temp, daily_forecast.wind_direction, daily_forecast.wind_strength, daily_forecast.time, daily_forecast.cat_id, category.cat_name, category.widget FROM daily_forecast join category on daily_forecast.cat_id = category.id WHERE daily_forecast.region = 1 AND daily_forecast.time LIKE 'Late Evening%' order by daily_forecast.id DESC limit 1";
                           ...
                           <!-- early morning weather forecast -->
                               <div class="item active animated fadeInUp"> 
                                  ...
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $EM_Jtime_duration ?></p>
                      ...
                      <!-- second item -->
                          ...
                          <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LM_Jtime_duration ?></p>
                        ...
                        <!-- third item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $A_Jtime_duration ?></p>
                        ...
                        <!-- fourth item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LE_Jtime_duration ?></p>
                           ...
                           <!-- early morning weather forecast -->
                               <div class="item active animated fadeInUp"> 
                                  ...
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $EM_Gtime_duration ?></p>
                      ...
                      <!-- second item -->
                          ...
                          <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LM_Gtime_duration ?></p>
                        ...
                        <!-- third item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $A_Gtime_duration ?></p>
                        ...
                        <!-- fourth item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LE_Gtime_duration ?></p>
                           ...
                           <!-- early morning weather forecast -->
                               <div class="item active animated fadeInUp"> 
                                  ...
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $EM_Mtime_duration ?></p>
                      ...
                      <!-- second item -->
                          ...
                          <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LM_Mtime_duration ?></p>
                        ...
                        <!-- third item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $A_Mtime_duration ?></p>
                        ...
                        <!-- fourth item -->
                               ...
                               <div>
                                  <div class="widg">
                                      ...
                                      <p class="time"><?php echo $LE_Mtime_duration ?></p>
