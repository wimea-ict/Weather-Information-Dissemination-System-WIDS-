 ...
 <!-- get the regions for the dailyforecast_region table-->
       ...
       <td>Mean Temp <?php echo form_error('mean_temp') ?></td>
        ...
        <tr><td>Wind direction <?php echo form_error('wind_direction') ?></td>
            ...
            <td><input type="text" class="form-control" name="wind_direction1" id="wind_direction1" placeholder="wind direction" value="<?php echo $wind_direction1; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_direction2" id="wind_direction2" placeholder="wind direction" value="<?php echo $wind_direction2; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_direction3" id="wind_direction3" placeholder="wind direction" value="<?php echo $wind_direction3; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_direction4" id="wind_direction4" placeholder="wind direction" value="<?php echo $wind_direction4; ?>" />
            </td>

      </tr>
        <tr><td>Wind strength <?php echo form_error('wind_strength') ?></td>

            <td><input type="text" class="form-control" name="wind_strength1" id="wind_strength1" placeholder="wind strength" value="<?php echo $wind_strength1; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_strength2" id="wind_strength2" placeholder="wind strength" value="<?php echo $wind_strength2; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_strength3" id="wind_strength3" placeholder="wind strength" value="<?php echo $wind_strength3; ?>" />
            </td>

            <td><input type="text" class="form-control" name="wind_strength4" id="wind_strength4" placeholder="wind strength" value="<?php echo $wind_strength4; ?>" />
            </td></tr>
        <!-- <tr>
        <td>Select Time</td>
        <td>
	...
	<tr><td>Outlook <?php echo form_error('cat_id') ?></td>
      ...
      <?php echo form_open_multipart('Daily_forecast/save'); ?>
      <td>Upload a background image for this forecast: </td>
      ...
      <input type="hidden" name="time3" value="Late Morning(06:00am-12:00pm)" />
